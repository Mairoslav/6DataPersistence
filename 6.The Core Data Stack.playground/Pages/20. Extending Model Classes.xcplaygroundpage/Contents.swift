...
// 03:31 Now, let's create a new Swift file. We'll call it 'Notebook+Extensions.swift'. Let's be sure to import CoreData and declare the extension.
...
// 04:07 Now, we need to do the same for Note. Complete the following task list to customize Note initialization - check following lesson '21. Customizing Note Initialization'. Once you do, both Notebook and Note will set their creation dates when they're created.
